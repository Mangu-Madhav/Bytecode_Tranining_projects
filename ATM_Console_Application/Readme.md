...
- Withdraw Cash – Allows withdrawals in multiples of 100 only.

- Deposit Cash – Accepts cash deposits and updates balance.

- Change PIN – Enables updating the existing PIN after verification.
